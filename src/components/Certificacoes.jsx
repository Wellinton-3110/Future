...
export function Certificacoes() {
  return (
    <div className="relative w-[100vw] h-[80vh] ">
      <h1 className="absolute z-10 w-[60%] h-[7%] top-[35%] left-[50%] translate-x-[-50%] text-[#696969] text-[30px] text-center font-bold md:text-[20px]">
        Em constante conformidade com as certificações atuais
      </h1>
      <li className="absolute w-[80%] h-[70%] bg-white left-[50%] top-[50%] translate-x-[-50%] translate-y-[-35%] border border-l-0 border-r-0 list-none --responsive--> ">
        <div className="absolute w-[1000px] flex justify-around items-center left-[50%] top-[50%] translate-x-[-50%] translate-y-[-5%] md:w-[650px] md:overflow-scroll">
          <i className="">
            <img
              src={c1}
              alt=""
              className="w-[90px] h-[100px] md:mr-[150px] md:ml-[50px]"
            />
          </i>
          <i className="">
            <img
